...
function showForm(formEl, spanEl, inputEl, buttonEl) {
    ...
    buttonEl.scrollIntoView({ behavior: 'smooth', block: 'end', inline: 'start' });
...
columnForm.addEventListener('submit', (e) => {
    ...
    if (lastColumn) {
        ...
        lastColumn.scrollIntoView({ behavior: 'smooth', block: 'end', inline: 'start' });
    }
...
function createColumnHeader(columnItemData, columnItem) {
    ...
    menuButton.addEventListener('click', () => {
        columnItem.scrollIntoView({ behavior: 'smooth', block: 'end', inline: 'start' });
...
function addingCard(cardElemId, value, color, description, columnItemData) {
    ...
    menuButton.addEventListener('click', () => {
        cardItem.scrollIntoView({ behavior: 'smooth', block: 'end', inline: 'start' });
